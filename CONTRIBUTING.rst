...
MetaCSV could always use more documentation, whether as part of the 
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   the CI runs for your pull request and make sure that the tests pass for all supported Python versions.
